...
// Ambil data transaksi untuk SEMUA cabang
$queryIncome = "SELECT t.*, b.branch_name 
                FROM transactions t 
                LEFT JOIN branches b ON t.branch_id = b.id 
                ORDER BY t.transaction_date DESC";
$resultIncome = $conn->query($queryIncome);

// Hitung total pemasukan dari semua transaksi
$totalIncomeQuery = "SELECT SUM(total_amount) AS total_income FROM transactions";
...
// Ambil data pengeluaran dari tabel finance (tipe expense) untuk SEMUA cabang
$queryExpense = "SELECT f.*, b.branch_name 
                 FROM finance f 
...
// Hitung total pengeluaran dari semua data expense
$totalExpenseQuery = "SELECT SUM(amount) AS total_expense FROM finance WHERE type='expense'";
  ...
  <div class="tab-content" id="financeTabContent">
    ...
    <div class="tab-pane fade show active" id="income" role="tabpanel" aria-labelledby="income-tab">
      <div class="mt-3 d-flex justify-content-between align-items-center">
        ...
        <a href="process/download_income.php" class="btn btn-success">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            if ($resultIncome && $resultIncome->num_rows > 0) {
              ...
              echo "<tr><td colspan='6' class='text-center'>Tidak ada data pemasukan.</td></tr>";
            }
            ?>
          </tbody>
        </table>
    ...
    <div class="tab-pane fade" id="expense" role="tabpanel" aria-labelledby="expense-tab">
      <div class="d-flex justify-content-between align-items-center mt-3">
        ...
        <div>
          ...
          <a href="process/download_expense.php" class="btn btn-success">
            <i class="fas fa-download"></i> Download PDF
          </a>
        </div>
      </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            if ($resultExpense && $resultExpense->num_rows > 0) {
              ...
              echo "<tr><td colspan='5' class='text-center'>Tidak ada data pengeluaran.</td></tr>";
            }
            ?>
          </tbody>
        </table>
