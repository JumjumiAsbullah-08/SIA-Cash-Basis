    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered" id="dataJournalSummary">
          ...
          <tbody>
            <?php
              // Query untuk menampilkan semua summary jurnal (tanpa filter)
...
<!-- (Modals untuk Tambah, Edit, Lihat & Hapus Journal Entry tetap sama seperti sebelumnya) -->
...
function loadCategoriesByBranch(branchId, targetSelect, callback) {
  $.ajax({
    url: 'process/get_cost_categories_by_branch.php',
    method: 'POST',
...
$(document).ready(function(){
  ...
  $("#journalType").on("change", function(){
    var type = $(this).val();
    if(type === "debit"){
      // Pindahkan nilai dari kredit ke debit jika ada
      ...
      // Pindahkan nilai dari debit ke kredit jika ada
  ...
  $("#addJournalEntryForm").on("submit", function(e){
    ...
    $.ajax({
      url: 'process/process_add_journal_entry.php',
      method: 'POST',
      data: formData,
      dataType: 'json',
      success: function(response){
  ...
  // Ganti binding langsung dengan event delegation menggunakan document
$(document).on("click", ".btn-view-journal-summary", function(){
    var branchId = $(this).data("branch_id");
    var period = $(this).data("period");
    $.ajax({
      url: 'process/get_journal_details.php',
      method: 'POST',
  ...
  $("#editJournalEntryForm").on("submit", function(e){
    ...
    var formData = $(this).serialize();
    $.ajax({
      url: 'process/process_edit_journal_entry.php',
      method: 'POST',
      data: formData,
      dataType: 'json',
      success: function(response){
  ...
  $("#deleteJournalEntryForm").on("submit", function(e){
    ...
    var formData = $(this).serialize();
    $.ajax({
      url: 'process/process_delete_journal_entry.php',
      method: 'POST',
      data: formData,
      dataType: 'json',
      success: function(response){
  ...
  $("#btnSearch").on("click", function(){
    ...
    $.ajax({
      url: 'process/search_journal_summary.php',
      method: 'POST',
      data: { period: period },
      dataType: 'json',
      success: function(response){
